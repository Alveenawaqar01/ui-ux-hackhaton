...
const Review = () => {
  return (
    <div className="flex justify-center items-center bg-black py-10">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-screen-sm sm:max-w-md md:max-w-lg lg:max-w-xl">
        <div className="text-center">
          <h2 className="text-yellow-500 font-semibold text-3xl sm:text-4xl lg:text-5xl pt-2">
            Client Review
          </h2>
          <h2 className="text-red-500 font-extralight text-2xl sm:text-3xl pt-2">
            Highly recommend
          </h2>
        ...
        <h2 className="text-lg font-semibold text-center">Alamin Hassan</h2>
        <h2 className="font-semibold text-center text-red-600">Food Specialist</h2>
      </div>
    </div>
  );
}
